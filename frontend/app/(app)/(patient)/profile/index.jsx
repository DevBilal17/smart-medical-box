...
import { useGetPatientProfileQuery, useUpdateProfilePictureMutation } from '../../../../src/store/api/patientApi';
...
export default function Profile() {
  ...
  const { data: deviceStatus } = useGetDeviceStatusQuery(undefined, { skip: !user?.deviceId });
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.quickInfo}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoText}>{profile?.age ? `${profile.age} years` : 'Not provided'}</Text>
        </View>
        <View style={styles.infoRow}>
          <Icon name="gender-male-female" size={20} color="#7f8c8d" />
          <Text style={styles.infoText}>{profile?.gender ? profile.gender.charAt(0).toUpperCase() + profile.gender.slice(1) : 'Not provided'}</Text>
        </View>
        {profile?.bloodGroup && (
          <View style={styles.infoRow}>
            <Icon name="water" size={20} color="#7f8c8d" />
            <Text style={styles.infoText}>Blood Group: {profile.bloodGroup}</Text>
          </View>
        )}
      </View>
        ...
        {menuItems.map((item, index) => (
          ...
          >
            ...
            <View style={styles.menuItemRight}>
              ...
              {item.route && <Icon name="chevron-right" size={24} color="#95a5a6" />}
            </View>
          </TouchableOpacity>
        ))}
      </View>
      ...
      <Text style={styles.copyright}>© 2024 Smart Medical Box v1.0.0</Text>
    </ScrollView>
  );
}
